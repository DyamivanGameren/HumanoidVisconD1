...
public class HumanoidArticulationStandAgent : Agent
{
    [Header("Robot Root")]
    ...
    //        // Store the ACTUAL joint position, not just drive.target
    //        float pos = joint.dofCount > 0 ? joint.jointPosition[0] : 0f;
    ...
    //        joint.jointFriction = friction;
    //        joint.xDrive = drive;
    //        initialJointPositions.Add(joint.jointPosition);
    ...
    //{
    //    // Step 1: Teleport the root using the proper AB method
    //    pelvis.TeleportRoot(startPosition, startRotation);

    //    // Step 2: Zero all velocities on root
    //    pelvis.linearVelocity = Vector3.zero;
    //    pelvis.angularVelocity = Vector3.zero;

    //    // Step 3: Directly write joint positions AND zero velocities
    //    int safeCount = 0;
    //    foreach (var joint in controllableJoints)
    //    {
    //        if (joint == null || joint.isRoot)
    ...
    //                break;
    //            case 2:
    //                joint.jointVelocity = new ArticulationReducedSpace(0f, 0f);
    //                break;
    //            case 3:
    ...
    //        // Directly SET joint position (not just the drive target)
    //        float targetPos = standingPoseTargets[safeCount];
    //        switch (joint.dofCount)
    //        {
    //            case 1:
    //                joint.jointPosition = new ArticulationReducedSpace(targetPos);
    //                break;
    //            case 2:
    //                joint.jointPosition = new ArticulationReducedSpace(targetPos, 0f);
    //                break;
    //            case 3:
    //                joint.jointPosition = new ArticulationReducedSpace(targetPos, 0f, 0f);
    //                break;
    //        }

    //        // Also set the drive target so it holds the pose
